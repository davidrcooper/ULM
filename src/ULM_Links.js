...
var ULM_Links = React.createClass({
    ...
    linkSelected: function linkSelected(index) {
        switch (index) {
            case 1:
    ...
    render: function render() {
        ...
        var ULM_Links_Node = React.createElement(
            'div',
            { style: this.styles.root },
            React.createElement(ULM_PageHeader, { text: 'Links...', justify: this.headerJustify, indent: this.headerIndent }),
            React.createElement(
                GridList,
                { padding: 0, cellHeight: this.cellHeight, cols: this.numCols, style: this.styles.gridList },
                this.tilesData.map(function (tile) {
                    return React.createElement(
                        GridTile,
                        { style: _this.styles.gridItem, key: tile.key },
                        React.createElement('img', { src: tile.img, style: _this.styles.image, onTouchTap: _this.linkSelected.bind(_this, tile.key) })
                    );
                })
            )
        );
        ...
        return React.createElement(Paper, { children: ULM_Links_Node, style: this.paperStyle, zDepth: 0, rounded: false });
    }
});
