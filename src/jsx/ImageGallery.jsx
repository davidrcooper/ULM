...
export default class ImageGallery extends React.Component {
  ...
  render() {
    ...
    const topOffset = this.props.topMargin.toString();
    const topOffsetString = topOffset.toString() + 'px';
    /*DRC 13/9/2016 */
            ...
            this._canNavigate() ?
              [
                this.props.showNav &&
                  ...
                  >
                    <div className='image-gallery-slides' style={{'marginTop':topOffsetString}}> /*DRC 13/9/2016-added style override for -48px top margin */
                      {slides}
                    </div>
                  </Swipeable>
              ]
