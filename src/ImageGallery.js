...
var ImageGallery = function (_React$Component) {
  ...
  _createClass(ImageGallery, [{
    ...
    value: function render() {
      ...
      /*DRC 13/9/2016 - Added prop to dynamically re-congfigure the overlay margin offset */
      /*DRC 13/9/2016 - build string to pass to the style override*/
      var topOffset = this.props.topMargin.toString();
      var topOffsetString = topOffset.toString() + 'px';
      /*DRC 13/9/2016 */
      ...
      this.props.items.map(function (item, index) {
        ...
        var slide = _react2.default.createElement(
          'div',
          {
            ...
            style: Object.assign(_this5._getSlideStyle(index), _this5.state.style),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this._canNavigate() ? [this.props.showNav && _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'image-gallery-slides', style: { 'marginTop': topOffsetString } },
              ' /*DRC 13/9/2016-added style override for -48px top margin */',
              slides
            )
          )] : _react2.default.createElement(
            'div',
...
ImageGallery.propTypes = {
  ...
  topMargin: _react2.default.PropTypes.number
};
