        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { id: 'ULM_Body' },
              this.state.optionSelected === 'Home' && React.createElement(ULM_Home, { deviceSize: this.props.deviceSize, windowWidth: this.props.widthWindow, deviceOrient: this.props.deviceOrient }),
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    IconButton,
                    { touch: true, onTouchTap: this.handleGoPageTop,
                      iconStyle: iconStyles.smallIcon, style: iconStyles.small },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(FlatButton, { label: 'MiniCat', primary: true, style: flatButtonStyle, onTouchTap: this.openMiniCatMenu, labelStyle: buttonTextStyle }),
                  React.createElement(
                    Popover,
                    {
                  ...
                  React.createElement(FlatButton, { label: 'Gallery', primary: true, style: flatButtonStyle, onTouchTap: this.openGalleryMenu, labelStyle: buttonTextStyle }),
                  React.createElement(
                    Popover,
                    {
                  ...
                  React.createElement(FlatButton, { label: 'Contact', primary: true, style: flatButtonStyle, labelStyle: buttonTextStyle })
                )
              ),
              React.createElement(
                'div',
                ...
                this.state.optionSelected === 'MC420' && React.createElement('img', { src: './images/MC420_full.png' }),
                this.state.optionSelected === 'MC460' && React.createElement('img', { src: './images/MC460_full.png' }),
                this.state.optionSelected === 'Links' && React.createElement(ULM_Links, { deviceSize: this.props.deviceSize, windowWidth: this.props.widthWindow, deviceOrient: this.props.deviceOrient })
              ),
              React.createElement(
                Toolbar,
                { noGutter: true },
