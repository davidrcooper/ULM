...
function getDeviceOrientation() {
  ...
  if ('orientation' in window) {
    ...
    if (100 * window.innerWidth / window.innerHeight < 100) return "portrait";else return "landscape";
  }
}
...
function getWindowsize() {
  ...
  if (w < 801) /* 960 */ /*600*/
    return "small";else if (w < 1160) /*960*/
    return "large";else return "huge";
}
...
window.onresize = function () {
  ...
  myContainer = ReactDOM.render(React.createElement(ULM_App, { myNewProp: 0, deviceOrient: orientationWindow, deviceSize: sizeWindow, windowWidth: widthWindow, style: ContainerStyle }), document.getElementById('app'));
  //	window.scrollTo(0,0);
};
...
var myContainer = ReactDOM.render(React.createElement(ULM_App, { myNewProp: 0, deviceOrient: orientationWindow, deviceSize: sizeWindow, windowWidth: widthWindow, style: ContainerStyle }), document.getElementById('app'));